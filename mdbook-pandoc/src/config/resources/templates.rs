...
use mdbook_pandoc_derive::pandoc_resource_gen;
use serde::{Deserialize, Serialize};
use strum::EnumIter;

/// Pandoc templates, written in the `templates` subfolder of the data directory.
#[pandoc_resource_gen("assets/pandoc/templates.toml")]
...
#[pandoc_resource_gen("assets/pandoc/template_assets.toml")]
#[derive(Clone, Default, Serialize, Deserialize, Debug, PartialEq, EnumIter)]
#[serde(rename_all = "snake_case")]
